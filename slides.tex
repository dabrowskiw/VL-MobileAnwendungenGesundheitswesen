...
\begin{frame}{Flutter}
    \note{
        ...
        \only<3->{
            ...
            \begin{itemize}
                ...
                \item Geeignetheit der Features für Problem (bsp. R ist super für Statistik, aber katastrophale String-Verarbeitung. Shells für Systemautomation, aber nicht für komplexe Datenverarbeitung. PHP für Webentwicklung, aber nicht für Kommandozeilentools)
    ...
    \only<3->{
        \begin{itemize}
            ...
            \item[\only<4-9>{\textbullet}\only<10->{?}] Ausreichende ROI bei fehlenden Vorkenntnissen
        \end{itemize}
    }
\end{frame}
